    ...
    const handleCreateAccount = async () => {
        ...
        try {
            ...
            if (error.response) {
              ...
              Alert.alert(error.response.data.message || 'Error al registrar intereses');
            } else {
  ...
  return (
    ...
    <ScrollView contentContainerStyle={styles.containerScroll}>
      ...
      <View style={styles.container2}>
            <ButtonTemas title={'Deportes'} backgroundColor={'#EDD820'} value={'deportes'} onPress={() => handleSelectTheme('deportes')} />
            <ButtonTemas title={'Tecnología'} backgroundColor={'#ED2620'} value={'tecnologia'} onPress={() => handleSelectTheme('tecnologia')} />
      </View>
      <View style={styles.container2}>
            <ButtonTemas title={'Viajes'} backgroundColor={'#2086ED'} value={'viajes'} onPress={() => handleSelectTheme('viajes')} />
            <ButtonTemas title={'Aventura'} backgroundColor={'#ED20BF'} value={'aventura'} onPress={() => handleSelectTheme('aventura')} />
      </View>
      <View style={styles.container2}>
            <ButtonTemas title={'Educación'} backgroundColor={'#ED9420'} value={'educacion'} onPress={() => handleSelectTheme('educacion')} />
            <ButtonTemas title={'Turismo'} backgroundColor={'#61C443'} value={'turismo'} onPress={() => handleSelectTheme('turismo')} />
      </View>
